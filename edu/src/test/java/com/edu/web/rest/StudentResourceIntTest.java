...
public class StudentResourceIntTest {
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getDurationYear()).isEqualTo(DEFAULT_DURATION_YEAR);
        assertThat(testStudent.getDurationMonth()).isEqualTo(DEFAULT_DURATION_MONTH);
        assertThat(testStudent.getDurationDay()).isEqualTo(DEFAULT_DURATION_DAY);
    }
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getDurationYear()).isEqualTo(UPDATED_DURATION_YEAR);
        assertThat(testStudent.getDurationMonth()).isEqualTo(UPDATED_DURATION_MONTH);
        assertThat(testStudent.getDurationDay()).isEqualTo(UPDATED_DURATION_DAY);
    }
